...
Die momentan aktuelle \ac{LTS}-Version von Typo3 ist die Version 7, welche aktuell (Stand Dezember 2016) noch immer unterstützt wird.
...
TypoScript ist eine eigens für Typo3 entwickelte Konfigurationssprache mit der es möglich ist, eine Typo3 Extension zu konfigurieren.
...
Zusätzlich zu der Konfiguration findet sich im selben Ordner noch eine Datei constants.txt, in welcher globale Konstanten für die Extension definiert werden können. \cite{TypoScript}
...
Wie genau Extension mit Hilfe von TypoScript konfiguriert werden können, ist in der offizellen Dokumentation oder in den Büchern von Patrick Lobacher genauer beschrieben.
...
Im HTML-Beispiel \ref{template example} ist ein Ausschnitt aus einem Template zu sehen, welcher einen ViewHelper für eine For-Schleife zeigt.
