...
Das eigentliche TypoScript für jede Extension ist unter \texttt{Configuration/TypoScript} (siehe Abbildung \ref{Extension Struktur}) in der Datei \texttt{setup.txt} zu finden.
...
Das Grundsystem, welches nach der Installation vorzufinden ist, basiert zum Teil schon auf Extensions, den sogenannten \texttt{System-Extensions}. Diese Extensions bringen grundlegende Funktionalitäten in das Grundsystem ein und erweitern dieses. 
...
\begin{itemize}
 \item \textbf{Modellklassen} welche nach dem \ac{MVC}-Prinzip reale Objekte verkörpern, sind unter \texttt{Classes/Domain/Model} zu finden.
...
Um den Grundstock für eine neue eigene Extension zu legen, kann der Extension-Builder\footnote{\url{https://typo3.org/extensions/repository/view/extension_builder}} verwendet werden. Dieser baut unter Angabe des Domain-Modells und der Controller die Grundextension auf, die dann mit Inhalt gefüllt werden kann.
