...
\newcommand{\FirmenLogoDeckblatt}{{\includegraphics[width=3cm]{Bilder/PDV-Systeme}}}
...
\newcommand{\Titel}{Evaluation moderner Webtechnologien für die Entwicklung eines modularen Supportportals}
...
\begin{center}
\vspace*{-2cm}
\FirmenLogoDeckblatt\hfill\includegraphics[width=4cm]{Bilder/logo_FHE}\\[1cm]
{\Huge \Titel}\\[2cm]
...
\include{Einleitung}
\newpage
\include{Portalserver}
\newpage
\include{Typo3}
\newpage
\include{Modulare_Extensions}
\newpage
\include{Neue_Webtechnologien}
\newpage
